...
team_dashboard = TeamDashboardByGeneralSplits(team_id=team_ids['MIL'], season=season_year)
...
# Retrieve the team dashboard stats for game splits
team_dashboard = TeamDashboardByGeneralSplits(team_id=team_ids['DET'], season=season_year)
